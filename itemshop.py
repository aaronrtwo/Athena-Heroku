...
class Athena:
    ...
    def main(self):
        ...
        print("Made by EthanC: https://github.com/EthanC/Athena\n")
        print("Heroku Version Made by aaronrtwo: https://github.com/aaronrtwo/Athena-Heroku\n")
    ...
    def Tweet(self, date: str):
        ...
        if self.supportACreator is not None:
            body = f"{body}\n\nUse Support-a-Creator Code: {self.supportACreator}"
